...
fetch(requestURL)
  ...
  function displayHighlight(business, elementID) {
    ...
    let pSpotinfo = document.createElement('div');
    let a = document.createElement('a');

    // Change the textContent property of the h3 element to contain the business name
    ...
    divSpotinfo.innerHTML = "<div>" + business.address + ", Vancouver, WA</div>";
    ...
    a.setAttribute('href', "https://www.espn.com");
